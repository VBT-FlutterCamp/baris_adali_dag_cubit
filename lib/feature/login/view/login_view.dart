import 'package:cubit_dio/feature/login/view/login_detail.dart';
...
class LoginView extends StatelessWidget {
  ...
  final String baseUrl = StirngConstants.baseUrl;
  ...
  TextFormField buildTextFormFieldLogin() {
    return TextFormField(
      controller:
          emailController, //TODOcontext.read<LoginCubit>().emailController wacht drumunda bunu kullan
      validator: (value) => (value ?? '').length > 6 ? null : '6 ten kucuk',
      decoration: InputDecoration(
          border: OutlineInputBorder(), labelText: strings.email),
    );
  }
  ...
  TextFormField buildTextFormFieldPassword() {
    return TextFormField(
      ...
      decoration: InputDecoration(
          border: OutlineInputBorder(), labelText: strings.password),
    );
  }
}
